...
public:
  ...
  ~EvolvingSketch() { cleanup(); }

  EvolvingSketch(const EvolvingSketch &other)
  ...
  auto operator=(const EvolvingSketch &other) -> EvolvingSketch & {
    if (this == &other)
      return *this;
  ...
  auto operator=(EvolvingSketch &&other) noexcept -> EvolvingSketch & {
    if (this == &other)
      return *this;
